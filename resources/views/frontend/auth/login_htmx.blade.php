...
{{-- <h5 class="mb-n1 font-12 color-highlight font-700 text-uppercase pt-1">Welcome</h5> --}}
        <p class="font-24 font-800 mb-3">{{__('Login')}}</p>
        <div class="form-custom form-label form-border form-icon mb-3 bg-transparent">
            <i class="bi bi-person-circle font-13"></i>
            <input type="text" name="email" class="form-control rounded-xs" id="c1login" placeholder="{{__('Email')}}" />
            <label for="c1login"  class="color-theme">{{__('Email')}}</label>
        ...
        <div class="form-custom form-label form-border form-icon mb-4 bg-transparent">
            ...
            <input type="password" name="password" class="form-control rounded-xs" id="c2login" placeholder="{{__('Password')}}" />
            <label for="c2login" class="color-theme">{{__('Password')}}</label>
            <span>({{__('required')}})</span>
        </div>
        ...
        <div class="row">
            <div class="col-6 text-start">
                <a href="#"
                   ...
                   class="font-11 color-theme opacity-40 pt-3 d-block">
                   {{__('Forgot Password')}}?
                </a>
            </div>
