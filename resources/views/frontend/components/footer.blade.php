<div id="footer-bar" class="footer-bar footer-bar-detached">
    <a href="#"  data-bs-toggle="offcanvas" data-bs-target="#menu-terms">
        <i class="bi bi-card-list font-20"
