<div class="header-bar header-fixed header-app header-bar-detached">
    ...
    <a data-bs-toggle="offcanvas" data-bs-target="#menu-main" href="#"><i class="bi bi-list color-theme font-20"></i></a>
    @auth('admin')
...
{{--    --}}
    ...
    <a href="#" data-bs-toggle="offcanvas"
       ...
       data-bs-target="#menu-cart">
        <em id="cart_icon_number" style="top:6px;right:5px"
            class="badge bg-highlight ms-1 font-10">{{ $carttotal ?? 0 }}</em>
        <i class="bi bi-cart4 font-20"></i>
    </a>
    ...
    @else
        <button href="#" style="all:unset;cursor: pointer;width: 30px; margin-right: 10px;" data-bs-toggle="offcanvas" data-bs-target="#menu-login" class="bi ">
