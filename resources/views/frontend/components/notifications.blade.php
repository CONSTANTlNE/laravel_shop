<div id="menu-bell"
    ...
    <div class="content">
            ...
            <div class="d-flex">
                <div class="align-self-center me-3">
                        <span class="icon icon-xxl gradient-red shadow-bg shadow-bg-s rounded-m color-white"><i
                                class="bi bi-heart font-24"></i></span>
                </div>
        ...
        <a href="#">
            <div class="d-flex">
                <div class="align-self-center me-3">
                        <span class="icon icon-xxl gradient-green shadow-bg shadow-bg-s rounded-m color-white"><i
                                class="bi bi-phone-vibrate font-30"></i></span>
                </div>
                <div class="align-self-center">
        ...
        <a href="#">
            <div class="d-flex">
                <div class="align-self-center me-3">
                        <span class="icon icon-xxl gradient-magenta shadow-bg shadow-bg-s rounded-m color-white"><i
                                class="bi bi-life-preserver font-26"></i></span>
                </div>
                <div class="align-self-center">
        ...
        <div class="pb-2"></div>
        <a href="page-activity.html" class="btn btn-full btn-m gradient-highlight shadow-bg shadow-bg-s mt-3">View
            All</a>
    </div>
