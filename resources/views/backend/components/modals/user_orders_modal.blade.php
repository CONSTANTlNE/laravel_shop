            ...
            <div class="border border-blue-dark rounded-s overflow-hidden ">
                <table class="table color-theme border-blue-dark mb-0">
                    ...
                    <tr class="color-white">
                        <th scope="col">
                            <h5 class="color-white font-15 mb-0">{{__('Created')}}</h5>
                        </th>
                        <th scope="col">
                            <h5 class="color-white font-15 mb-0">{{__('Order')}} No</h5>
                        </th>
                        <th scope="col">
                            <h5 class="color-white font-15 mb-0">{{__('Shipping')}}</h5>
                        </th>
                        <th scope="col">
                            <h5 class="color-white font-15 mb-0">{{__('City')}}</h5>
                        </th>
                        <th scope="col">
                            <h5 class="color-white font-15 mb-0">{{__('Total')}}</h5>
                        </th>
                        <th scope="col">
                            <h5 class="color-white font-15 mb-0">
                                {{__('Items')}}
                            </h5>
                        </th>
                    </tr>
