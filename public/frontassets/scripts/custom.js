...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init_template() {
        ...
        if (splide.length) {
            ...
            var dynamicslider = document.querySelectorAll('.dynamic-slider');
            if (dynamicslider.length) {
                dynamicslider.forEach(function (e) {
                    var dynamic = new Splide('#' + e.id, {
                        type: 'loop',
                        focus: 'start',
                        autoplay: true,
                        interval: 4000,
            ...
            var dynamicslider2 = document.querySelectorAll('.dynamic-slider2');
            if (dynamicslider2.length) {
                dynamicslider2.forEach(function (e) {
                    var dynamic = new Splide('#' + e.id, {
                        type: 'loop',
                        focus: 'start',
                        autoplay: true,
                        ...
                        perPage: 6, // default
                        breakpoints: {
                            992: { // Bootstrap large breakpoint
                                perPage: 4
                            },
                            1200: { // Bootstrap large breakpoint
                                perPage: 4
                            },
                            750: { // you can adjust this
                                perPage: 2
